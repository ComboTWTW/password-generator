...
const Password = (word:any) => {
    return <div className={`flex flex-col`}>
        <div className={`${style.padding} flex flex-row bg-cardDark justify-between items-center`}>
          ...
          <img src={icon} alt="copy" className="justify-end h-[32px] w-[32px] md:active:h-[28px] md:active:w-[28px] cursor-pointer" onClick={() => {navigator.clipboard.writeText(word.password)}}/>
        </div>
